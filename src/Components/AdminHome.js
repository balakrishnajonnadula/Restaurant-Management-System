    ...
    <div>
      <nav class="navbar navbar-dark bg-dark p-3">
        <div class="d-flex col-12 col-md-3 col-lg-2 mb-2 mb-lg-0 flex-wrap flex-md-nowrap justify-content-between">
          <Link
            class="navbar-brand brand fs-3 fw-bold ps-3"
            to={"/admin"}
            style={{ color: "yellow" }}
          >
              ...
              <ul class="nav flex-column">
                <li class="nav-item">
                  ...
                  >
                    ...
                    <span class="ml-2 ps-3 text-white">Dashboard</span>
                  </Link>
                </li>
                <li class="nav-item">
                  <Link class="nav-link" to={"/admin/orders"}>
                    ...
                    <span class="ml-2 ps-3 text-white">Orders</span>
                  </Link>
                </li>
                <li class="nav-item">
                  <Link class="nav-link" href="#">
                    ...
                    <span class="ml-2 ps-3 text-white">Products</span>
                  </Link>
                </li>
                <li class="nav-item">
                  <Link class="nav-link" to={"/admin/customers"}>
                    ...
                    <span class="ml-2 ps-3 text-white">Customers</span>
                  </Link>
                </li>
                {/* <li class="nav-item">
                  <a
